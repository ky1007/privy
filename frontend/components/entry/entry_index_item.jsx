    ...
    <section className="entry-index-container">
      ...
      <aside className="entry-index-metadata">
        <div className="inline">
          {pathUsername ? <h3>{moment(entry.created_at).format('MMMM Do')}</h3> : <h3><Link to={`/${writers[entry.writer_id].username}/entries`}>{writers[entry.writer_id].username}</Link></h3> }
